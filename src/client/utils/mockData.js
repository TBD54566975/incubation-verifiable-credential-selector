const mfaRes = [
  ...
  },
  {
    ...
    SecurityQuestionJson: '["What is your favorite color?"]',
    SuccessFlag: 'Processing',
  },
  {
    step: 'TokenMethod',
    TokenMethodJson: '["xxx-xxx-1234","xxx-xxx-5678"]',
    SuccessFlag: 'Processing',
  },
  { step: 'TokenSent', TokenSentFlag: true, SuccessFlag: 'Processing' },
  { SuccessFlag: 'Processing' },
  { step: 'Success', SuccessFlag: 'Success' },
];
let counter = 0;
...
export default {
  ...
  '/api/selectBank': () => ({
    ...
    img: 'https://logos-list.s3-us-west-2.amazonaws.com/bank_of_america_logo.png',
  }),
  ...
  '/api/banks': () => ({
    ...
    preference: {
      ...
      // promptOrgName: 'ExampleOrg',
      // showLoginConsent: false,
      // termsUrl: 'https://sophtron.com/Home/Terms'
    },
    meta: '',
    banks: [
      {
        name: 'Ally Bank',
        institutionName: 'AllyBank',
        url: 'https://www.ally.com',
        img: 'https://sophtron.com/images/banklogos/ally%20bank.png',
      },
      {
        name: 'Bank of America',
        institutionName: 'BankofAmerica',
        url: 'https://connect.bnymellon.com/ConnectLogin/login/LoginPage.jsp',
        img: 'https:/ /logos-list.s3-us-west-2.amazonaws.com/bank_of_america_logo.png',
      },
      {
        ...
        img: 'https://sophtron.com/images/banklogos/barclays.png',
      },
      {
        name: 'BB&T',
        institutionName: 'BB&T',
        url: 'https://www.bbt.com/online-access/online-banking/default.page',
        img: 'https://sophtron.com/images/banklogos/bbt.png',
      },
      {
        name: 'Capital One',
        institutionName: 'CapitalOne',
        url: 'https://www.capitalone.com/',
        img: 'https://sophtron.com/images/banklogos/capital%20one.png',
      },
      {
        name: 'Charles Schwab',
        institutionName: 'CharlesSchwab',
        url: 'https://client.schwab.com/Login/SignOn/CustomerCenterLogin.aspx',
        img: 'https://sophtron.com/images/banklogos/charles%20schwab.png',
      },
      {
        name: 'Citibank',
        institutionName: 'Citibank',
        url: 'https://online.citi.com/US/login.do',
        img: 'https://sophtron.com/images/banklogos/citibank.png ',
      },
      {
        name: 'USAA',
        institutionName: 'USAA',
        url: 'https://www.usaa.com/inet/ent_logon/Logon',
        img: 'https://sophtron.com/images/banklogos/usaa.png',
      },
      {
        name: 'Fifth Third Bank',
        institutionName: 'FifthThirdBank',
        url: 'http://www.53.com/content/fifth-third/en/login.html',
        img: 'https://logos-list.s3-us-west-2.amazonaws.com/fifth_third_bank_logo.png',
      },
      {
        name: 'GoldMan Sachs',
        institutionName: 'GoldManSachs',
        url: 'https://www.goldman.com/',
        img: 'https://sophtron.com/images/banklogos/goldman%20sachs.png',
      },
      {
        name: 'HSBC Bank',
        institutionName: 'HSBCDirect',
        url: 'https://www.services.online-banking.us.hsbc.com/',
        img: 'https://sophtron.com/images/banklogos/hsbc%20bank.png',
      },
      {
        name: 'Chase Bank',
        institutionName: 'Chase',
        url: 'https://www.chase.com/',
        img: 'https://sophtron.com/images/banklogos/chase.png',
      },
      {
        name: 'Morgan Stanley',
        institutionName: 'MorganStanley',
        url: 'https://www.morganstanleyclientserv.com/',
        img: 'https://sophtron.com/images/banklogos/morgan%20stanley.png',
      },
      {
        name: 'PNC Bank',
        institutionName: 'PNCBank',
        url: 'https://www.pnc.com/en/personal-banking/banking/online-and-mobile-banking.html',
        img: 'https://logos-list.s3-us-west-2.amazonaws.com/pnc_bank_logo.png',
      },
      {
        name: 'State Street',
        institutionName: 'StateStreet',
        url: 'https://www.statestreetbank.com/online-banking',
        img: 'https://sophtron.com/images/banklogos/state%20street.png',
      },
      {
        name: 'SunTrust',
        institutionName: 'SunTrust',
        url: 'https://onlinebanking.suntrust.com/',
        img: 'https://logos-list.s3-us-west-2.amazonaws.com/suntrust_logo.png',
      },
      {
        name: 'TD Bank',
        institutionName: 'TDBank',
        url: 'https://onlinebanking.tdbank.com',
        img: 'https://logos-list.s3-us-west-2.amazonaws.com/td_bank_logo.png',
      },
      {
        name: 'US Bank',
        institutionName: 'USBank',
        url: 'https://www.usbank.com/index.html',
        img: 'https://logos-list.s3-us-west-2.amazonaws.com/us_bank_logo.png',
      },
      {
        name: 'Wells Fargo',
        institutionName: 'WellsFargo',
        url: 'https://connect.secure.wellsfargo.com/auth/login/present?origin=tpb',
        img: 'https://sophtron.com/images/banklogos/wells%20fargo.png',
      },
    ],
  }),
};
