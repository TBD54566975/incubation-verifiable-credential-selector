...
module.exports = {
    ...
    async login(req, res) {
        const data = await service.login(req.body.institution_id, req.body.connection_id, req.body.credentials, req.context);
        if (data) {
    ...
    async answerChallenge(req, res) {
        const data = await service.answerChallenge(req.body.challenges, req.context);
        res.send(data || {});
    },
};
