...
exports.answerChallenge = exports.mfa = exports.login = exports.selectInstitution = exports.institutions = exports.search = void 0;
const contract_1 = require("../../shared/contract");
const config = require("../config");
const logger = require("../infra/logger");
const providers_1 = require("./providers");
const mxClient = new providers_1.MxApi();
const sophtronClient = new providers_1.SophtronApi();
...
async function institutions(context) {
    const client = getApiClient(context);
    let retBanks = demoBanks;
...
async function selectInstitution(institution, context) {
...
async function login(institution_id, connection_id, credentials, context) {
    // console.log(context);
    ...
    if (institution_id) {
        const res = await client.CreateConnection({
            institution_id,
            credentials,
            initial_job_type: contract_1.JobType.AGG,
        }, context.user_id);
        if (res) {
            return res;
        }
...
exports.login = login;
async function mfa(job_id, context) {
    const client = getApiClient(context);
...
exports.mfa = mfa;
async function answerChallenge(challenges, context) {
    const client = getApiClient(context);
...
exports.answerChallenge = answerChallenge;
